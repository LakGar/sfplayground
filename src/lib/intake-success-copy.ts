...
> = {
  sponsors: {
    ...
    links: [
      { href: INSTAGRAM_PROFILE, label: "See events on Instagram" },
      { href: MAILTO, label: "Email the team" },
    ],
  },
  startups: {
    headline: "Thanks — we have your snapshot.",
    body: "We’ll follow up if there’s a strong fit for an upcoming pitch night, intro, or program. Watch your inbox for a note from the SFPLAYGROUND team.",
    links: [
      { href: "/pitch-playoffs", label: "Pitch Playoffs format" },
  ...
  vcs: {
    ...
    links: [
      { href: INSTAGRAM_PROFILE, label: "Past events on Instagram" },
      { href: MAILTO, label: "Get in touch" },
    ],
  },
  speakers: {
    ...
    links: [
      { href: INSTAGRAM_PROFILE, label: "Events on Instagram" },
      { href: MAILTO, label: "Email the team" },
    ],
  },
};
