...
import { NETWORK_PATHS, NETWORK_WHY_MASONRY } from "@/data/network-page-data";
...
export default function NetworkWhyMasonry() {
  const { headline, subline, tiles } = NETWORK_WHY_MASONRY;
              ...
              {NETWORK_PATHS.map((card, index) => (
                ...
                >
                  <AccentCard
                    ...
                    tone={card.tone}
                    href={`/network/apply?type=${card.id}`}
                  />
                </Reveal>
              ))}
            </div>
              ...
              <article className="group relative h-full min-h-[420px] overflow-hidden rounded-[1.75rem] md:rounded-[2rem]">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-8">
                  ...
                  <div>
                    ...
                    <div className="mt-6">
                      <ArrowButton href="/network/apply" label="Start application" dark />
                    </div>
                  </div>
                </div>
              </article>
