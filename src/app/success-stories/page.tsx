      ...
      <div className="relative h-[50vh] min-h-[400px] flex items-center justify-center px-4 md:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-oswald text-white mb-4">
            Success <span className="text-[#feca00]">Stories</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {successStories.map((story) => (
              <Link
                ...
                className="group relative h-96 rounded-lg overflow-hidden border border-white/20 hover:border-[#feca00] transition-all duration-300"
              >
                {/* Image */}
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <h3 className="text-2xl font-oswald text-white mb-2 group-hover:text-[#feca00] transition-colors">
                    {story.title}
                  </h3>
                  ...
                  <div className="mt-4 flex items-center text-[#feca00] font-oswald text-sm group-hover:translate-x-2 transition-transform">
                    Read Story →
                  </div>
                </div>
              </Link>
