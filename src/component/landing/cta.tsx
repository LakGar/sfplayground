  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url('${getProxiedImageUrl(getContent("cta.backgroundImage") || "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=2832&auto=format&fit=crop", { w: 1600 })}')`,
        }}
